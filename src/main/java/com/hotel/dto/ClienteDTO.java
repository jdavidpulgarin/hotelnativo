...
public class ClienteDTO {
    ...
    public ClienteDTO(String cedula, String nombre, String segundoNombre,
                      String apellido, String apellido2,
                      String email, String telefono,
                      String nacionalidad, String ciudadOrigen) {
        this.cedula       = cedula;
        this.nombre       = nombre;
    ...
    public String getDocumento()        { return cedula; }
    public String getSubtipoDocumento() { return null; }
}
