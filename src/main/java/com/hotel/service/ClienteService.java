 ...
 *
 * GRASP: Alta Cohesión - solo maneja operaciones de clientes.
 * GRASP: Controlador - coordina los casos de uso relacionados con clientes.
 * SOLID: S - responsabilidad única: lógica de negocio de clientes.
 * SOLID: D - depende de interfaces IClienteDAO / IClienteBusqueda, no de implementaciones.
 */
